...
for (const marker of ['BuildStartMenu', 'BuildPauseMenu', 'Escape', 'RestartScene', 'ShowMainMenu', 'ScaleWithScreenSize', '1920f, 1080f', 'Schedule flight']) {
...
for (const marker of ['AirportFlowValidator', 'ValidateFlow', 'flow.valid', 'PushAlert(issue.message, issue.focusPosition)']) {
