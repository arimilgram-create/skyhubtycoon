...
- Expanded simulation for money, staff, satisfaction, reputation, power, water, passenger route, baggage route, airfield route, unlocks, missions, concessions, and flight rewards.
- Larger airport catalog covering doors, check-in variants, security, multiple gate/runway sizes, aircraft stands, service roads, fueling, maintenance, baggage sorting, shops, comfort items, staff rooms, and utilities.
